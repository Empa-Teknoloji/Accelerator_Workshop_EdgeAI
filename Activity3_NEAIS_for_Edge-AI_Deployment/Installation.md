...
This guide covers the installation steps for the software required to develop our "Hand Character Recognition" application on Windows and Ubuntu. The steps include installing NanoEdge AI Studio, STM32CubeIDE, STM32CubeProgrammer, Tera Term and related software packages.
...
First, download STM32CubeIDE 1.17.0 (latest) from here: [https://www.st.com/en/development-tools/stm32cubeide.html#get-software](https://www.st.com/en/development-tools/stm32cubeide.html#get-software)
...
NOTE 1: Make sure the installation path does not contain non-ASCII characters or spaces.
...
**This section covers installation steps for NanoEdge AI Studio on Windows and Ubuntu.**

NEAIS can be downloaded from the link below for both Windows and Ubuntu. macOS is not officially supported; use a virtual machine (e.g., Parallels) as a workaround.

**[https://stm32ai.st.com/download-nanoedgeai/](https://stm32ai.st.com/download-nanoedgeai/)**

**Filling the Form**

Complete the form on the site to receive the download link and license key by email.

![Untitled](./Additionals/NEAIS-Setup/Untitled0.png)

**Installing NanoEdge AI Studio on Windows using the .exe**
...
**Installing NanoEdge AI Studio on Ubuntu using the .deb**

- Right-click the downloaded .deb file,
- Open it with "Software Install",
...
Users receive their license keys by email at the address provided in the download form.
